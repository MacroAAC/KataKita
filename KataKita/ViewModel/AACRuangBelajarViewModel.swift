...
class AACRuangBelajarViewModel: ObservableObject {
    ...
    func loadCardsData() {
        let rawData = [
            ...
            [("tulis", "tulis", "#CFF0C8", "#000000"), ("baca", "baca", "#CFF0C8", "#000000"), ("gambar", "gambar", "#CFF0C8", "#000000"), ("warnai", "warnai", "#CFF0C8", "#000000"), ("buang", "buang", "#CFF0C8", "#000000")],
            ...
            [("kertas", "kertas", "#F2B95C", "#000000"), ("buku", "buku", "#F2B95C", "#000000"), ("pensil", "pensil", "#F2B95C", "#000000"), ("rautan", "rautan", "#F2B95C", "#000000"), ("pensil warna", "pewarna", "#F2B95C", "#000000")],
            [("kursi", "kursi", "#F2B95C", "#000000"), ("meja", "meja", "#F2B95C", "#000000"), ("tempat sampah", "tong sampah", "#F2B95C", "#000000"), ("lem", "lem", "#F2B95C", "#000000"), ("gunting", "gunting", "#F2B95C", "#000000")],
